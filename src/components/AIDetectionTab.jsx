...
export default function AIDetectionTab({ simulationState, currentScenario, language }) {
  ...
  const thermalAvatars = {
    "Elephant": "https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?q=80&w=350&auto=format&fit=crop",
    "Wild Boar": "https://images.unsplash.com/photo-1607613009820-a29f7bb81c04?q=80&w=350&auto=format&fit=crop",
