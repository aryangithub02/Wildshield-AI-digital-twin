              ...
              <img
                src={
                  (activeScenario.image && (activeScenario.image.startsWith("data:") || activeScenario.image.startsWith("http")))
                    ...
                    : (activeScenario.sourceFile
                        ? `/sample-test-images/${activeScenario.sourceFile}`
                        : (
                ...
                onError={(e) => {
                  ...
                  if (activeScenario.sourceFile) {
                    e.target.src = `/sample-test-images/${activeScenario.sourceFile}`;
                  } else {
